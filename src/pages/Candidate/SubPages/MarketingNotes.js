...
const MarketingNotes = () => {
  ...
  const getsAllNote = async () => {
    const res = await getAllNotes({ recordType: 'Marketing', candidateId: candidateId });
    ...
    <div className="">
      <div className="w-full   px-6 flex-col justify-start items-start gap-6 inline-flex font-normal mt-5">
        ...
        <div className="flex flex-col gap-4 w-full ">
          {isNewNote && (
            <NewNote isNewNote={isNewNote} setIsNewNote={setIsNewNote} noteType='Marketing' fetchData={getsAllNote} />
          )}
